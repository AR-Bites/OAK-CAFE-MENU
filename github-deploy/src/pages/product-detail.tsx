...
const allProducts = [
  ...
  { id: 111, name: 'Double Espresso', nameKey: 'double-espresso', descriptionKey: 'double-espresso-desc', price: '2.75 JD', image: 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'beverage', category: 'hot-drinks', description: 'Double shot of rich espresso for the ultimate coffee experience' },
  { id: 112, name: 'Cappuccino', nameKey: 'cappuccino', descriptionKey: 'cappuccino-desc', price: '3.50 JD', image: 'https://images.unsplash.com/photo-1578985545062-69928b1d9587?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'beverage', category: 'hot-drinks', description: 'Classic Italian coffee with steamed milk and foam' },
  { id: 113, name: 'Cortado', nameKey: 'cortado', descriptionKey: 'cortado-desc', price: '3.25 JD', image: 'https://images.unsplash.com/photo-1571115764595-644a1f56a55c?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'beverage', category: 'hot-drinks', description: 'Spanish coffee with equal parts espresso and steamed milk' },
  { id: 114, name: 'Latte', nameKey: 'latte', descriptionKey: 'latte-desc', price: '3.50 JD', image: 'https://images.unsplash.com/photo-1544787219-7f47ccb76574?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'beverage', category: 'hot-drinks', description: 'Creamy coffee with espresso and steamed milk' },
  { id: 115, name: 'Americano', nameKey: 'americano', descriptionKey: 'americano-desc', price: '3.00 JD', image: 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'beverage', category: 'hot-drinks', description: 'Classic black coffee made with espresso and hot water' },
  { id: 106, name: 'Turkish Coffee Single', nameKey: 'turkish-coffee-single', descriptionKey: 'turkish-coffee-single-desc', price: '3.00 JD', image: 'https://images.unsplash.com/photo-1578985545062-69928b1d9587?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'beverage', category: 'hot-drinks', description: 'Traditional Turkish coffee prepared in authentic copper pot' },
  ...
  { id: 602, name: 'Lungo', nameKey: 'lungo', descriptionKey: 'lungo-desc', price: '3.00 JD', image: 'https://images.unsplash.com/photo-1544787219-7f47ccb76574?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'beverage', category: 'hot-drinks', description: 'Long shot espresso with more water for a milder taste' },
  { id: 603, name: 'White Coffee', nameKey: 'white-coffee', descriptionKey: 'white-coffee-desc', price: '1.45 JD', image: 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'beverage', category: 'hot-drinks', description: 'Traditional Lebanese white coffee with orange blossom water' },
  { id: 604, name: 'Sandy Chocolate', nameKey: 'sandy-chocolate', descriptionKey: 'sandy-chocolate-desc', price: '4.00 JD', image: 'https://images.unsplash.com/photo-1578985545062-69928b1d9587?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'beverage', category: 'hot-drinks', description: 'Rich chocolate drink with a unique sandy texture' },
  { id: 605, name: 'Filter Coffee', nameKey: 'filter-coffee', descriptionKey: 'filter-coffee-desc', price: '3.75 JD', image: 'https://images.unsplash.com/photo-1571115764595-644a1f56a55c?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'beverage', category: 'hot-drinks', description: 'Smooth drip coffee brewed through a paper filter' },
  { id: 606, name: 'White Mocha', nameKey: 'white-mocha', descriptionKey: 'white-mocha-desc', price: '3.60 JD', image: 'https://images.unsplash.com/photo-1544787219-7f47ccb76574?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'beverage', category: 'hot-drinks', description: 'Coffee with white chocolate and steamed milk' },
  { id: 607, name: 'Chili Chocolate', nameKey: 'chili-chocolate', descriptionKey: 'chili-chocolate-desc', price: '4.00 JD', image: 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'beverage', category: 'hot-drinks', description: 'Spicy hot chocolate with a hint of chili pepper' },
  { id: 608, name: 'Spanish Latte', nameKey: 'spanish-latte', descriptionKey: 'spanish-latte-desc', price: '3.75 JD', image: 'https://images.unsplash.com/photo-1578985545062-69928b1d9587?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'beverage', category: 'hot-drinks', description: 'Sweet latte with condensed milk Spanish style' },
  { id: 609, name: 'Dark Mocha', nameKey: 'dark-mocha', descriptionKey: 'dark-mocha-desc', price: '3.60 JD', image: 'https://images.unsplash.com/photo-1571115764595-644a1f56a55c?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'beverage', category: 'hot-drinks', description: 'Rich coffee with dark chocolate and steamed milk' },
  { id: 116, name: 'Turkish Coffee Double', nameKey: 'turkish-coffee-double', descriptionKey: 'turkish-coffee-double-desc', price: '3.50 JD', image: 'https://images.unsplash.com/photo-1544787219-7f47ccb76574?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'beverage', category: 'hot-drinks', description: 'Double serving of traditional Turkish coffee' },
  
  // Cold Coffee
  { id: 107, name: 'Iced Caramel Macchiato', nameKey: 'iced-caramel-macchiato', descriptionKey: 'iced-caramel-macchiato-desc', price: '3.95 JD', image: 'https://images.unsplash.com/photo-1544787219-7f47ccb76574?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'beverage', category: 'cold-coffee', description: 'Chilled espresso with vanilla syrup, steamed milk and caramel drizzle' },
  { id: 117, name: 'Iced Dark Mocha', nameKey: 'iced-dark-mocha', descriptionKey: 'iced-dark-mocha-desc', price: '3.85 JD', image: 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'beverage', category: 'cold-coffee', description: 'Cold coffee with dark chocolate and ice' },
  { id: 610, name: 'Iced Flat White', nameKey: 'iced-flat-white', descriptionKey: 'iced-flat-white-desc', price: '3.40 JD', image: 'https://images.unsplash.com/photo-1578985545062-69928b1d9587?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'beverage', category: 'cold-coffee', description: 'Chilled flat white with smooth espresso and cold milk' },
  { id: 611, name: 'Iced White Mocha', nameKey: 'iced-white-mocha', descriptionKey: 'iced-white-mocha-desc', price: '3.85 JD', image: 'https://images.unsplash.com/photo-1571115764595-644a1f56a55c?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'beverage', category: 'cold-coffee', description: 'Cold coffee with white chocolate and ice' },
  { id: 108, name: 'Cold Brew', nameKey: 'cold-brew', descriptionKey: 'cold-brew-desc', price: '5.25 JD', image: 'https://images.unsplash.com/photo-1544787219-7f47ccb76574?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'beverage', category: 'cold-coffee', description: 'Smooth, slow-steeped coffee served over ice for maximum flavor' },
  { id: 118, name: 'Iced Americano', nameKey: 'iced-americano', descriptionKey: 'iced-americano-desc', price: '3.15 JD', image: 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'beverage', category: 'cold-coffee', description: 'Cold black coffee made with espresso and cold water' },
  { id: 612, name: 'Iced Latte', nameKey: 'iced-latte', descriptionKey: 'iced-latte-desc', price: '3.60 JD', image: 'https://images.unsplash.com/photo-1578985545062-69928b1d9587?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'beverage', category: 'cold-coffee', description: 'Chilled latte with espresso and cold milk' },
  ...
  // Fresh Juice
  { id: 109, name: 'The Oak Seasonal Fresh Juice', nameKey: 'oak-seasonal-juice', descriptionKey: 'oak-seasonal-juice-desc', price: '4.90 JD', image: 'https://images.unsplash.com/photo-1544787219-7f47ccb76574?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'beverage', category: 'fresh-juice', description: 'Our signature seasonal blend of the freshest fruits available' },
  { id: 119, name: 'Mango Mint Juice', nameKey: 'mango-mint-juice', descriptionKey: 'mango-mint-juice-desc', price: '4.90 JD', image: 'https://images.unsplash.com/photo-1578985545062-69928b1d9587?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'beverage', category: 'fresh-juice', description: 'Fresh mango juice with mint leaves' },
  ...
  { id: 636, name: 'Carrot Juice', nameKey: 'carrot-juice', descriptionKey: 'carrot-juice-desc', price: '4.70 JD', image: 'https://images.unsplash.com/photo-1544787219-7f47ccb76574?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'beverage', category: 'fresh-juice', description: 'Fresh carrot juice packed with vitamins' },
  { id: 637, name: 'Lemon with Mint Juice', nameKey: 'lemon-mint-juice', descriptionKey: 'lemon-mint-juice-desc', price: '4.50 JD', image: 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'beverage', category: 'fresh-juice', description: 'Fresh lemon juice with mint' },
  { id: 638, name: 'Lemonade Juice', nameKey: 'lemonade-juice', descriptionKey: 'lemonade-juice-desc', price: '4.00 JD', image: 'https://images.unsplash.com/photo-1578985545062-69928b1d9587?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'beverage', category: 'fresh-juice', description: 'Classic fresh lemonade' },
  { id: 120, name: 'Orange Juice', nameKey: 'orange-juice', descriptionKey: 'orange-juice-desc', price: '4.00 JD', image: 'https://images.unsplash.com/photo-1571115764595-644a1f56a55c?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'beverage', category: 'fresh-juice', description: 'Fresh squeezed orange juice' },
  { id: 110, name: 'Pomegranate Juice', nameKey: 'pomegranate-juice', descriptionKey: 'pomegranate-juice-desc', price: '4.90 JD', image: 'https://images.unsplash.com/photo-1544787219-7f47ccb76574?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'beverage', category: 'fresh-juice', description: 'Fresh pomegranate juice packed with antioxidants' },
  { id: 639, name: 'Mango Basil Juice', nameKey: 'mango-basil-juice', descriptionKey: 'mango-basil-juice-desc', price: '4.90 JD', image: 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'beverage', category: 'fresh-juice', description: 'Fresh mango juice with basil leaves' },
  ...
  { id: 229, name: 'Shawarma Chicken', nameKey: 'shawarma-chicken', descriptionKey: 'shawarma-chicken-desc', price: '6.00 JD', image: 'https://images.unsplash.com/photo-1529006557810-274b9b2fc783?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'sandwiches', description: 'Traditional chicken shawarma with garlic sauce and vegetables' },
  { id: 230, name: 'Chicken Fajita Sandwich', nameKey: 'chicken-fajita-sandwich', descriptionKey: 'chicken-fajita-sandwich-desc', price: '5.50 JD', image: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ca4b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'sandwiches', description: 'Grilled chicken fajita with peppers and onions in a warm tortilla' },
  { id: 231, name: 'Halloumi Sandwich', nameKey: 'halloumi-sandwich', descriptionKey: 'halloumi-sandwich-desc', price: '5.50 JD', image: 'https://images.unsplash.com/photo-1509722747041-616f39b57569?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'sandwiches', description: 'Grilled halloumi cheese with fresh vegetables and herbs' },
  { id: 232, name: 'Chicken Quesadilla', nameKey: 'chicken-quesadilla', descriptionKey: 'chicken-quesadilla-desc', price: '8.00 JD', image: 'https://images.unsplash.com/photo-1513456852971-30c0b8199d4d?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'sandwiches', description: 'Grilled tortilla filled with chicken, cheese, and peppers' },
  { id: 233, name: 'Beef Fajita Sandwich', nameKey: 'beef-fajita-sandwich', descriptionKey: 'beef-fajita-sandwich-desc', price: '7.00 JD', image: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ca4b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'sandwiches', description: 'Seasoned beef fajita with peppers and onions in a warm tortilla' },
  ...
  { id: 33, name: 'Penne Arrabbiata', nameKey: 'penne-arrabbiata', descriptionKey: 'penne-arrabbiata-desc', price: '5.25 JD', image: 'https://images.unsplash.com/photo-1621996346565-e3dbc353d2e5?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'italian', description: 'Spicy penne pasta with arrabbiata sauce and chili peppers' },
  { id: 34, name: 'Spaghetti Al-Pesto', nameKey: 'spaghetti-al-pesto', descriptionKey: 'spaghetti-al-pesto-desc', price: '6.50 JD', image: 'https://images.unsplash.com/photo-1551183053-bf91a1d81141?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'italian', description: 'Spaghetti with basil pesto sauce and pine nuts' },
  { id: 35, name: 'Pina Rose', nameKey: 'pina-rose', descriptionKey: 'pina-rose-desc', price: '6.00 JD', image: 'https://images.unsplash.com/photo-1570197788417-0e82375c9371?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'italian', description: 'Penne pasta with creamy rose sauce and herbs' },
  { id: 36, name: 'Spaghetti Aglio Shrimps', nameKey: 'spaghetti-aglio-shrimps', descriptionKey: 'spaghetti-aglio-shrimps-desc', price: '8.75 JD', image: 'https://images.unsplash.com/photo-1621996346565-e3dbc353d2e5?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'italian', description: 'Spaghetti with garlic oil, shrimps, and fresh herbs' },
  { id: 37, name: 'Kanolone', nameKey: 'kanolone', descriptionKey: 'kanolone-desc', price: '5.00 JD', image: 'https://images.unsplash.com/photo-1574894709920-11b28e7367e3?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'italian', description: 'Traditional Italian cannelloni with ricotta and spinach filling' },
  
  // Salads
  { id: 133, name: 'Chef Salad', nameKey: 'chef-salad', descriptionKey: 'chef-salad-desc', price: '4.75 JD', image: 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'salads', description: 'Fresh chef salad with mixed greens and chef selection' },
  { id: 134, name: 'Greek Salad', nameKey: 'greek-salad', descriptionKey: 'greek-salad-desc', price: '3.75 JD', image: 'https://images.unsplash.com/photo-1544726135-e4b4a4b0a2b1?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'salads', description: 'Traditional Greek salad with feta cheese, olives, and Mediterranean vegetables' },
  { id: 135, name: 'Caesar Salad', nameKey: 'caesar-salad', descriptionKey: 'caesar-salad-desc', price: '3.75 JD', image: 'https://images.unsplash.com/photo-1546793665-c74683f339c1?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'salads', description: 'Classic Caesar salad with romaine lettuce, croutons, and parmesan cheese' },
  { id: 136, name: 'Smoked Salmon Salad', nameKey: 'smoked-salmon-salad', descriptionKey: 'smoked-salmon-salad-desc', price: '7.50 JD', image: 'https://images.unsplash.com/photo-1540189549336-e6e99c3679fe?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'salads', description: 'Premium smoked salmon salad with fresh greens' },
  
  // Soup
  { id: 137, name: 'Mushroom Soup', nameKey: 'mushroom-soup', descriptionKey: 'mushroom-soup-desc', price: '3.50 JD', image: 'https://images.unsplash.com/photo-1547592166-23ac45744acd?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'soup', description: 'Creamy mushroom soup with fresh herbs and a touch of cream' },
  { id: 138, name: 'Seafood Soup', nameKey: 'seafood-soup', descriptionKey: 'seafood-soup-desc', price: '4.75 JD', image: 'https://images.unsplash.com/photo-1519707456040-8be4aa1d7b80?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'soup', description: 'Rich seafood soup with fresh ocean ingredients' },
  { id: 139, name: 'Corn Soup', nameKey: 'corn-soup', descriptionKey: 'corn-soup-desc', price: '3.75 JD', image: 'https://images.unsplash.com/photo-1476718406336-bb5a9690ee2a?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'soup', description: 'Sweet corn soup with fresh corn kernels and herbs' },
  ...
  { id: 301, name: 'Fukhara Freekeh', nameKey: 'fukhara-freekeh', descriptionKey: 'fukhara-freekeh-desc', price: '6.75 JD', image: 'https://images.unsplash.com/photo-1546833999-b9f581a1996d?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'main-course', description: 'Traditional Middle Eastern freekeh with aromatic spices' },
  { id: 302, name: 'Fukhara Chicken Creamy', nameKey: 'fukhara-chicken-creamy', descriptionKey: 'fukhara-chicken-creamy-desc', price: '8.75 JD', image: 'https://images.unsplash.com/photo-1532550907401-a500c9a57435?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'main-course', description: 'Tender chicken in creamy white sauce with herbs' },
  { id: 303, name: 'Meat Slice', nameKey: 'meat-slice', descriptionKey: 'meat-slice-desc', price: '9.75 JD', image: 'https://images.unsplash.com/photo-1558030006-450675393462?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'main-course', description: 'Sliced meat with traditional Middle Eastern spices' },
  { id: 304, name: 'Meat Sajiye', nameKey: 'meat-sajiye', descriptionKey: 'meat-sajiye-desc', price: '10.00 JD', image: 'https://images.unsplash.com/photo-1558030006-450675393462?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'main-course', description: 'Sizzling meat sajiye with onions and peppers' },
  { id: 305, name: 'Fukhara Chicken Lemon', nameKey: 'fukhara-chicken-lemon', descriptionKey: 'fukhara-chicken-lemon-desc', price: '8.50 JD', image: 'https://images.unsplash.com/photo-1532550907401-a500c9a57435?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'main-course', description: 'Tender chicken with fresh lemon sauce and herbs' },
  { id: 306, name: 'Chicken Fajita Sizzling', nameKey: 'chicken-fajita-sizzling', descriptionKey: 'chicken-fajita-sizzling-desc', price: '8.75 JD', image: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ca4b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'main-course', description: 'Sizzling chicken fajita with peppers and onions' },
  { id: 307, name: 'Beef Straganoff', nameKey: 'beef-straganoff', descriptionKey: 'beef-straganoff-desc', price: '9.75 JD', image: 'https://images.unsplash.com/photo-1558030006-450675393462?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'main-course', description: 'Classic beef stroganoff with mushrooms and sour cream' },
  { id: 308, name: 'Chicken Grill', nameKey: 'chicken-grill', descriptionKey: 'chicken-grill-desc', price: '9.00 JD', image: 'https://images.unsplash.com/photo-1532550907401-a500c9a57435?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'main-course', description: 'Grilled chicken breast seasoned with herbs and spices' },
  ...
  { id: 202, name: 'Mac and Cheese', nameKey: 'mac-and-cheese', descriptionKey: 'mac-and-cheese-desc', price: '4.50 JD', image: 'https://images.unsplash.com/photo-1543826173-7ad31f7659f6?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'appetizers', description: 'Creamy macaroni and cheese with rich cheddar sauce' },
  { id: 401, name: 'Chips and Dips', nameKey: 'chips-and-dips', descriptionKey: 'chips-and-dips-desc', price: '5.00 JD', image: 'https://images.unsplash.com/photo-1541833590746-8b9858c50b0b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'appetizers', description: 'Crispy chips served with assorted dips and sauces' },
  { id: 402, name: 'Kibbeh', nameKey: 'kibbeh', descriptionKey: 'kibbeh-desc', price: '3.50 JD', image: 'https://images.unsplash.com/photo-1565299585323-38174c9d1bb4?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'appetizers', description: 'Traditional Middle Eastern fried kibbeh with bulgur and meat' },
  { id: 403, name: 'Popcorn', nameKey: 'popcorn', descriptionKey: 'popcorn-desc', price: '3.00 JD', image: 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'appetizers', description: 'Freshly popped corn with seasoning' },
  { id: 404, name: 'Freekeh with Cream', nameKey: 'freekeh-with-cream', descriptionKey: 'freekeh-with-cream-desc', price: '5.00 JD', image: 'https://images.unsplash.com/photo-1565299585323-38174c9d1bb4?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'appetizers', description: 'Traditional freekeh served with rich cream sauce' },
  { id: 405, name: 'French Fries', nameKey: 'french-fries', descriptionKey: 'french-fries-desc', price: '3.00 JD', image: 'https://images.unsplash.com/photo-1541833590746-8b9858c50b0b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'appetizers', description: 'Golden crispy French fries seasoned with salt' },
  { id: 406, name: 'Mushroom Saute', nameKey: 'mushroom-saute', descriptionKey: 'mushroom-saute-desc', price: '4.50 JD', image: 'https://images.unsplash.com/photo-1565299585323-38174c9d1bb4?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'appetizers', description: 'Sautéed mushrooms with garlic and herbs' },
  { id: 407, name: 'Cheese Roll', nameKey: 'cheese-roll', descriptionKey: 'cheese-roll-desc', price: '4.50 JD', image: 'https://images.unsplash.com/photo-1541833590746-8b9858c50b0b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'appetizers', description: 'Crispy cheese rolls with melted cheese filling' },
  { id: 408, name: 'Yalanji', nameKey: 'yalanji', descriptionKey: 'yalanji-desc', price: '3.00 JD', image: 'https://images.unsplash.com/photo-1565299585323-38174c9d1bb4?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'appetizers', description: 'Traditional stuffed grape leaves with rice and herbs' },
  { id: 409, name: 'Onion Rings', nameKey: 'onion-rings', descriptionKey: 'onion-rings-desc', price: '3.50 JD', image: 'https://images.unsplash.com/photo-1541833590746-8b9858c50b0b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'appetizers', description: 'Crispy golden onion rings with seasoning' },
  { id: 410, name: 'Grilled Halloumi', nameKey: 'grilled-halloumi', descriptionKey: 'grilled-halloumi-desc', price: '4.00 JD', image: 'https://images.unsplash.com/photo-1565299585323-38174c9d1bb4?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'appetizers', description: 'Grilled halloumi cheese with herbs and olive oil' },
  { id: 411, name: 'Nuts', nameKey: 'nuts', descriptionKey: 'nuts-desc', price: '4.00 JD', image: 'https://images.unsplash.com/photo-1541833590746-8b9858c50b0b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'appetizers', description: 'Mixed roasted nuts with Middle Eastern spices' },
  { id: 412, name: 'Jalapeno Paper', nameKey: 'jalapeno-paper', descriptionKey: 'jalapeno-paper-desc', price: '3.50 JD', image: 'https://images.unsplash.com/photo-1565299585323-38174c9d1bb4?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'appetizers', description: 'Stuffed jalapeño peppers with cheese and spices' },
  { id: 413, name: 'Chicken Tender', nameKey: 'chicken-tender', descriptionKey: 'chicken-tender-desc', price: '5.50 JD', image: 'https://images.unsplash.com/photo-1608039829572-78524f79c4c7?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'appetizers', description: 'Crispy chicken tenders with dipping sauce' },
  { id: 414, name: 'Potato Wedges', nameKey: 'potato-wedges', descriptionKey: 'potato-wedges-desc', price: '3.50 JD', image: 'https://images.unsplash.com/photo-1541833590746-8b9858c50b0b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'appetizers', description: 'Seasoned potato wedges with herbs and spices' },
  { id: 415, name: 'Chicken Cheese Balls', nameKey: 'chicken-cheese-balls', descriptionKey: 'chicken-cheese-balls-desc', price: '5.50 JD', image: 'https://images.unsplash.com/photo-1608039829572-78524f79c4c7?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'appetizers', description: 'Fried chicken and cheese balls with crispy coating' },
  { id: 416, name: 'Sambusak', nameKey: 'sambusak', descriptionKey: 'sambusak-desc', price: '3.00 JD', image: 'https://images.unsplash.com/photo-1565299585323-38174c9d1bb4?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'appetizers', description: 'Traditional Middle Eastern pastry with savory filling' },
  { id: 417, name: 'Loaded Waffle Fries', nameKey: 'loaded-waffle-fries', descriptionKey: 'loaded-waffle-fries-desc', price: '5.25 JD', image: 'https://images.unsplash.com/photo-1541833590746-8b9858c50b0b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'appetizers', description: 'Waffle fries topped with cheese, bacon, and special sauce' },
  { id: 418, name: 'Mozzarella Sticks', nameKey: 'mozzarella-sticks', descriptionKey: 'mozzarella-sticks-desc', price: '3.50 JD', image: 'https://images.unsplash.com/photo-1565299585323-38174c9d1bb4?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'appetizers', description: 'Crispy mozzarella sticks with marinara dipping sauce' },
