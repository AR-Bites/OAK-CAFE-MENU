...
// COMPLETE MENU - EXACT ITEMS FROM USER'S COMPREHENSIVE LIST ONLY
const allProducts = [
  // HOT DRINKS - EXACT FROM USER LIST
  ...
  // COLD COFFEE - EXACT FROM USER LIST  
  ...
  // ADDITIONAL SANDWICH ITEMS - COMPLETE SECTION (IDs 640-659) - UPDATED FROM AUTHENTIC MENU
  ...
  { id: 641, name: 'The Oak Sandwich', nameKey: 'oak-sandwich', descriptionKey: 'oak-sandwich-desc', price: '9.00 JD', image: 'https://images.unsplash.com/photo-1539252554453-80ab65ce3586?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'sandwiches', description: 'Our signature sandwich with premium ingredients' },
  { id: 642, name: 'Shawarma Meat', nameKey: 'shawarma-meat', descriptionKey: 'shawarma-meat-desc', price: '7.50 JD', image: 'https://images.unsplash.com/photo-1529006557810-274b9b2fc783?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'sandwiches', description: 'Traditional Middle Eastern meat shawarma' },
  { id: 643, name: 'Crispy Chicken Burger', nameKey: 'crispy-chicken-burger', descriptionKey: 'crispy-chicken-burger-desc', price: '6.50 JD', image: 'https://images.unsplash.com/photo-1553979459-d2229ba7433a?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'sandwiches', description: 'Crispy fried chicken burger with fresh toppings' },
  { id: 644, name: 'Shawarma Chicken', nameKey: 'shawarma-chicken', descriptionKey: 'shawarma-chicken-desc', price: '6.00 JD', image: 'https://images.unsplash.com/photo-1529006557810-274b9b2fc783?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'sandwiches', description: 'Traditional chicken shawarma wrap' },
  { id: 645, name: 'Chicken Fajita Sandwich', nameKey: 'chicken-fajita-sandwich', descriptionKey: 'chicken-fajita-sandwich-desc', price: '5.50 JD', image: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ca4b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'sandwiches', description: 'Chicken fajita in fresh bread' },
  { id: 646, name: 'Halloumi Sandwich', nameKey: 'halloumi-sandwich', descriptionKey: 'halloumi-sandwich-desc', price: '5.50 JD', image: 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'sandwiches', description: 'Grilled halloumi cheese sandwich' },
  { id: 647, name: 'Chicken Quesadilla', nameKey: 'chicken-quesadilla', descriptionKey: 'chicken-quesadilla-desc', price: '8.00 JD', image: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ca4b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'sandwiches', description: 'Grilled tortilla with chicken and melted cheese' },
  { id: 648, name: 'Chicken Crispy Sandwich', nameKey: 'chicken-crispy-sandwich', descriptionKey: 'chicken-crispy-sandwich-desc', price: '6.50 JD', image: 'https://images.unsplash.com/photo-1553979459-d2229ba7433a?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'sandwiches', description: 'Crispy fried chicken sandwich' },
  { id: 649, name: 'Beef Fajita Sandwich', nameKey: 'beef-fajita-sandwich', descriptionKey: 'beef-fajita-sandwich-desc', price: '7.00 JD', image: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ca4b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'sandwiches', description: 'Spiced beef fajita sandwich' },

  // BREAKFAST ITEMS - COMPLETE SECTION (IDs 650-669) - MISSING FROM PREVIOUS IMPLEMENTATION
  { id: 650, name: 'Eggs of Your Choice', nameKey: 'eggs-choice', descriptionKey: 'eggs-choice-desc', price: '4.50 JD', image: 'https://images.unsplash.com/photo-1525351484163-7529414344d8?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'breakfast', description: 'Fresh eggs prepared to your preference' },
  { id: 651, name: 'Manageesh Labneh and Rocca', nameKey: 'manageesh-labneh-rocca', descriptionKey: 'manageesh-labneh-rocca-desc', price: '3.25 JD', image: 'https://images.unsplash.com/photo-1578357078586-491adf1aa5ba?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'breakfast', description: 'Traditional manageesh with labneh and arugula' },
  { id: 652, name: 'Halloumi Croissant', nameKey: 'halloumi-croissant', descriptionKey: 'halloumi-croissant-desc', price: '5.50 JD', image: 'https://images.unsplash.com/photo-1555507036-ab1f4038808a?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'breakfast', description: 'Buttery croissant with grilled halloumi cheese' },
  { id: 653, name: 'Manageesh Zaatar and Vegetables', nameKey: 'manageesh-zaatar-vegetables', descriptionKey: 'manageesh-zaatar-vegetables-desc', price: '3.50 JD', image: 'https://images.unsplash.com/photo-1578357078586-491adf1aa5ba?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'breakfast', description: 'Traditional zaatar manageesh with fresh vegetables' },
  { id: 654, name: 'Zaatar and Pomegranate', nameKey: 'zaatar-pomegranate', descriptionKey: 'zaatar-pomegranate-desc', price: '2.50 JD', image: 'https://images.unsplash.com/photo-1578357078586-491adf1aa5ba?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'breakfast', description: 'Zaatar bread topped with pomegranate seeds' },
  { id: 655, name: 'Turkey Omelette Croissant', nameKey: 'turkey-omelette-croissant', descriptionKey: 'turkey-omelette-croissant-desc', price: '6.00 JD', image: 'https://images.unsplash.com/photo-1555507036-ab1f4038808a?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'breakfast', description: 'Fluffy omelette with turkey in buttery croissant' },
  { id: 656, name: 'Manageesh Nabulsi Cheese', nameKey: 'manageesh-nabulsi-cheese', descriptionKey: 'manageesh-nabulsi-cheese-desc', price: '3.50 JD', image: 'https://images.unsplash.com/photo-1578357078586-491adf1aa5ba?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'breakfast', description: 'Traditional manageesh with authentic Nabulsi cheese' },
  { id: 657, name: 'Tuna Sandwich', nameKey: 'tuna-sandwich', descriptionKey: 'tuna-sandwich-desc', price: '8.00 JD', image: 'https://images.unsplash.com/photo-1539252554453-80ab65ce3586?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'breakfast', description: 'Fresh tuna sandwich with vegetables and mayo' },
  { id: 658, name: 'Avocado Omelette', nameKey: 'avocado-omelette', descriptionKey: 'avocado-omelette-desc', price: '5.50 JD', image: 'https://images.unsplash.com/photo-1525351484163-7529414344d8?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'breakfast', description: 'Healthy omelette with fresh avocado slices' },
  { id: 659, name: 'Manageesh Falafel', nameKey: 'manageesh-falafel', descriptionKey: 'manageesh-falafel-desc', price: '4.00 JD', image: 'https://images.unsplash.com/photo-1578357078586-491adf1aa5ba?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'breakfast', description: 'Traditional manageesh topped with crispy falafel' },
  { id: 660, name: 'Turkey Croissant', nameKey: 'turkey-croissant', descriptionKey: 'turkey-croissant-desc', price: '5.50 JD', image: 'https://images.unsplash.com/photo-1555507036-ab1f4038808a?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'breakfast', description: 'Buttery croissant with sliced turkey' },
  { id: 661, name: 'Manageesh Mix Cheese', nameKey: 'manageesh-mix-cheese', descriptionKey: 'manageesh-mix-cheese-desc', price: '5.00 JD', image: 'https://images.unsplash.com/photo-1578357078586-491adf1aa5ba?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'breakfast', description: 'Traditional manageesh with mixed cheese varieties' },
  { id: 662, name: 'Manageesh Molasses and Tahini', nameKey: 'manageesh-molasses-tahini', descriptionKey: 'manageesh-molasses-tahini-desc', price: '3.75 JD', image: 'https://images.unsplash.com/photo-1578357078586-491adf1aa5ba?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'breakfast', description: 'Sweet manageesh with molasses and tahini' },

  // ADDITIONAL APPETIZERS - COMPLETE SECTION (IDs 670-689)
  { id: 670, name: 'Chips and Dips', nameKey: 'chips-dips', descriptionKey: 'chips-dips-desc', price: '5.00 JD', image: 'https://images.unsplash.com/photo-1513456852971-30c0b8199d4d?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'appetizers', description: 'Crispy chips with variety of dips' },
