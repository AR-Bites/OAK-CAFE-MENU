...
const allProducts = [
  ...
  { id: 251, name: 'Club Sandwich', price: '8.50 JD', image: 'https://images.unsplash.com/photo-1540420773420-3366772f4999?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'sandwiches', description: 'Classic club sandwich with turkey, bacon, lettuce, and tomato on toasted bread' },
  { id: 252, name: 'Chicken Sandwich', price: '7.50 JD', image: 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600', type: 'food', category: 'sandwiches', description: 'Grilled chicken breast sandwich with fresh vegetables and special sauce' },
