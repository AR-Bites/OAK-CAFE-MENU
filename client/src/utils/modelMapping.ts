// 3D Model mapping - ALL available 3D models properly mapped
export const modelMapping: Record<string, string> = {
  // === PIZZA CATEGORY === (All pizzas have dedicated models)
  ...
  // === PASTA & ITALIAN === (All pasta dishes have dedicated models)
  ...
  'lasagna': '/models/Fettuccine Alfredo_1752072150333.glb',
  'spaghetti-carbonara': '/models/Sea Food Pasta_1752072136017.glb',
  'risotto-mushroom': '/models/pennaArabita_1752072019113.glb',
  
  // === BURGERS & SANDWICHES === (All have specific models)
  ...
  'oak-sandwich': '/models/cheeseSteakSandwich_1752057967756.glb',
  'club-sandwich': '/models/halloumiSandwich_1752057967753.glb',
  'chicken-sandwich': '/models/chickenZingerSandwich_1752057967758.glb',
  'grilled-cheese': '/models/halloumiSandwich_1752057967753.glb',
  
  // === MAIN COURSES & STEAKS === (All have dedicated models)
  'grilled-chicken': '/models/grilledChicken_1752057967760.glb',
  'the-oak-steak': '/models/Steak_1752072087985.glb',
  'oak-steak': '/models/Steak_1752072087985.glb',
  ...
  // === MEXICAN & FAJITAS === (All have specific models)
  ...
  // === BREAKFAST ITEMS === (All have proper models)
  ...
  // === SALADS === (All have dedicated models)
  ...
  // === APPETIZERS === (All properly mapped)
  ...
  'chicken-noodle-soup': '/models/Fettuccine Alfredo_1752072150333.glb',
  
  // === DESSERTS === (Using available sweet-looking models)
  'san-sebastian-cake': '/models/macAndCheese_1752071917275.glb',
  'chocolate-cake': '/models/macAndCheese_1752071917275.glb',
  'tiramisu': '/models/macAndCheese_1752071917275.glb',
  'cheesecake': '/models/macAndCheese_1752071917275.glb',
  'kenafa-naama': '/models/manageeshMolassesAndTahini_1752071973508.glb',
  'ice-cream-vanilla': '/models/macAndCheese_1752071917275.glb',
  'ice-cream-chocolate': '/models/macAndCheese_1752071917275.glb',
  'ice-cream-strawberry': '/models/macAndCheese_1752071917275.glb',
  
  // === SEAFOOD === (All mapped properly)
